        ...
        <div className="p-4 z-10 border border-gray-400 rounded-lg shadow bg-black bg-opacity-90 text-white absolute top-5 right-4 w-[350px]">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-row justify-center items-center space-x-5 ">
              <button
                className="bg-gradient-to-br from-pink-950 to-white text-black py-2 px-10 mt-5 rounded-lg"
                onClick={handleUpdate}
              >
                Update
              </button>
              <button
                className="bg-gradient-to-br from-white to-pink-950 text-black py-2 px-10 mt-5 rounded-lg"
                onClick={deleteview}
              >
                Delete
              </button>
